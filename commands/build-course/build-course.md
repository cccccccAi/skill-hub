...
基于5关框架模板（见 [course-framework.md](course-framework.md)），为该主题生成课程大纲。
...
参考文件模板见 [file-templates.md](file-templates.md)。
...
按审计清单（见 [audit-checklist.md](audit-checklist.md)）逐关检查生成的课程。
