...
根据用户的评审选择和综合逻辑，基于访谈素材生成一篇完整的终稿文章（800-1000 字符）。

生成规则：

- 以用户选择的 Writer 风格为主基调
- 融入另一位 Writer 的突出元素（标题、金句或结构）
- 应用 Critic 评审中指出的改进建议
- 读取 `commands/interview-write/style-guide.md` 获取写作规范
