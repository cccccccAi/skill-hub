...
<p style="color: #94A3B8; background: #F8FAFC;">
  这段文字很难看清
</p>

<!-- ✅ 正确：对比度 > 4.5:1 -->
<p style="color: #0F172A; background: #F8FAFC;">
  这段文字清晰可读
</p>
```
...
<div onclick="navigate()" style="padding: 16px; border: 1px solid #e5e7eb; cursor: pointer; transition: all 200ms;">
  可点击的卡片（hover 时有阴影变化）
</div>
```
